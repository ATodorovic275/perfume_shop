...
<body>
    ...
    <!--  <section class="preloader">
     ...
     <section id="portfolio" class="light-bg">
                              ...
                              <figure class="effect-bubba">
                                   ...
                                   <figcaption>
                                        <?php 
                                             ...
                                             echo "<p>".$red->opis."</p>";
                                             echo "<a href='#' data-toggle='modal' data-target='#Modal-".$red->id."'>Viwe more</a>";
                                         ?>
          ...
          <?php 
               echo "<div class='modal fade' id='Modal-".$red->id."' tabindex='-1' role='dialog' aria-labelledby='Modal-label-".$red->id."'>";
           ?>
...
<!--                               <div class="modal-works"><span>Branding</span><span>Web Design</span></div>
 -->                            <?php 
                               ...
                               ?>
                              <!-- <p>Moderan i dinamičan muškarac sada ima još jedno tajno oružje nepobedivog šarma.</p> -->
                         </div>
                         <div class="modal-footer">                           
                              <?php 
                                   ...
                                   echo "<button type='button' disabled title='Morate se ulogovati' class='btn btn-default btn-left dodaj-u-korpu' data-dismiss='modal' data-id='".$red->id."'>Dodaj u korpu</button>";

                                   endif
                               ?>

                              <!-- <button type="button" class="btn btn-default btn-left" data-dismiss="modal">Dodaj u korpu</button> -->
     ...
     <script src="js/filtriranje.js"></script>
