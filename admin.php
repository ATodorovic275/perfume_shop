...
<body>
     ...
     <section id="" data-stellar-background-ratio="0.5">
           <div class="container">
               <div class="row">
                    <div class="col-lg-3">
                         <a href="#" id="sviKorisnici" data-id="1" class="admin-btn" name="sviKorisnici">Prikazi sve korisnike</a>
                         <a href="#" id="dodKor" class="admin-btn" name="dodKor">Dodaj korisnika</a>
                         <a href="#" id="sviProizvodi" data-id="3" class="admin-btn" name="sviProizvodi">Prikazi sve proizvode</a>
                         <a href="#" id="dodPro" class="admin-btn" name="dodPro">Dodaj prozivod</a>
                    </div>
     ...
     <script type="text/javascript" src="js/novaAnketa.js"></script>
