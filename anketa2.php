...
?>
	...
	<?php 
		...
		$odgovori = "select odgovor, o.id from ankete a inner join odgovori o on a.id = o.id_ankete where a.id = 1";
	 ...
	 ?>
    	...
    	<?php 
    	 ...
    	 ?>
			<!-- <br/><input type="submit" id='gla' name="glasaj" values='Glasaj' data-id=''><br/><br/> -->
